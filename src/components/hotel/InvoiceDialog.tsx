// components/hotel/InvoiceDialog.tsx
                    ...
                    <div class="invoice">
                        ...
                        <div class="item-section">
                            ...
                            <div class="item-row">
                                ...
                                <span>$${(reservation.roomRate * reservation.nights).toFixed(2)}</span>
                            </div>
                            ${services?.map(service => `
                                <div class="item-row">
                                    <div>
                                        <p>${service.name}</p>
                                        <p class="item-details">${service.quantity} × $${service.price.toFixed(2)}</p>
                                    </div>
                        ...
                        <div class="totals-section">
                            ...
                            <div class="total-row">
                                <span>Tax (10%):</span>
                                <span>$${(reservation.totalAmount * 0.1).toFixed(2)}</span>
                            </div>
                            <div class="total-row grand-total">
                                <span>TOTAL:</span>
                                <span>$${(reservation.totalAmount * 1.1).toFixed(2)}</span>
                            </div>
                        </div>
                ...
                <div ref={invoiceRef} className="bg-background p-4 rounded-lg border font-mono text-sm">
                        ...
                        {services?.map((service, index) => (
                            <div key={index} className="flex justify-between text-xs mb-2">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">{service.quantity} × ${service.price.toFixed(2)}</p>
                                </div>
                    ...
                    <div className="border-t border-dashed pt-2 space-y-1 text-xs">
                        ...
                        <div className="flex justify-between text-base font-bold border-t pt-2 mt-2">
                            <span>TOTAL:</span>
                            <span className="text-hotel">${(reservation.totalAmount * 1.1).toFixed(2)}</span>
                        </div>
                    </div>
